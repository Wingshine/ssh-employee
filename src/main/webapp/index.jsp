...
<body>
	<div class="headerBar">
		<div class="logoBar login_logo">
			<div class="comWidth">
				<div class="logo fl">
					<a href="#"><img
						src="<%=request.getContextPath()%>/images/logo.jpg" alt="慕课网"></a>
				</div>
		...
		<h3><s:actionerror/></h3>
			<div class="login_cont">
				<ul class="login">
					...
					<li class="mb_10">
						<input type="text" name="username" class="login_input user_icon"></li>
					<li class="l_tit">密码</li>
					<li class="mb_10">
						<input type="text" name="password" class="login_input user_icon"></li>
	...
	<div class="footer">
		...
		<p class="web">
			<a href="#"><img
				src="<%=request.getContextPath()%>/images/webLogo.jpg" alt="logo"></a><a
